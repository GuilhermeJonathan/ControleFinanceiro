...
public class CreateParcelaCommandValidator : AbstractValidator<CreateParcelaCommand>
{
    public CreateParcelaCommandValidator()
    {
        RuleFor(x => x.CartaoCreditoId)
            .NotEmpty().WithMessage("CartaoCreditoId é obrigatório.");
