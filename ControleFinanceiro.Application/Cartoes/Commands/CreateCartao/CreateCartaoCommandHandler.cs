...
public class CreateCartaoCommandHandler(ICartaoCreditoRepository repository, IUnitOfWork unitOfWork)
    : IRequestHandler<CreateCartaoCommand, Guid>
{
    ...
    {
        var cartao = new CartaoCredito(request.Nome, request.DiaVencimento);
