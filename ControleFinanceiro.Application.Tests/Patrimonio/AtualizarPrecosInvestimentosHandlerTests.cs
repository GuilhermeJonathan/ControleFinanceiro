...
public class AtualizarPrecosInvestimentosHandlerTests
{
    ...
    private static Investimento ComTicker(string ticker) =>
        new(UserId, ticker, TipoInvestimento.Acoes, MoedaPatrimonio.BRL, null, ticker, 100m, 100m, null);
    ...
    public async Task Handle_ShouldUpdatePricesAndWriteHistory()
    {
        ...
        petr.ValorAtual.Should().Be(42.5m);
